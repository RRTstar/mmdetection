...
# dataset settings
data_root = '/media/volume4/joon_fun/tensorflow-great-barrier-reef'
...
train_dataset = dict(
    ...
    dataset=dict(
        ...
        img_prefix=data_root + 'image_data/train/',
        pipeline=[
...
data = dict(
    ...
    val=dict(
        ...
        img_prefix=data_root + 'image_data/valid/',
